...
export default function RegisterLibraryScreen() {
  ...
  }, [libraryName, ownerName, city, totalSeats, email, password]);
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      // Auto-create seats (1..N) right after registration.
      // Now token is stored, so authenticated endpoints work immediately.
      try {
