...
<html>
  ...
  <body>
    <div class="card">
      ...
      <div class="row"><div><div class="k">Date</div><div class="v">${formatDate(row.createdAt)}</div></div></div>
          ...
          <View style={styles.card}>
            <View style={styles.rowTop}>
              ...
              <View style={{ flex: 1, minWidth: 0 }}>
                ...
                <Text style={styles.meta} numberOfLines={1}>{`Paid via UPI (Razorpay) · ${formatDate(item.createdAt)}`}</Text>
          ...
          <View style={styles.rowTop}>
            ...
            <View style={{ flex: 1, minWidth: 0 }}>
              ...
              <Text style={styles.meta} numberOfLines={1}>
                {item.expiryDate ? `Valid till: ${formatDate(item.expiryDate)}` : `Date: ${formatDate(item.createdAt)}`}
              </Text>
            </View>
          </View>
        </View>
