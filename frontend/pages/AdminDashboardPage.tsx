...
const styles = StyleSheet.create({
  ...
  activityDot: { width: 10, height: 10, borderRadius: 999, backgroundColor: '#4F46E5' },
  ...
  retryBtn: { marginTop: 14, backgroundColor: '#0F172A', borderRadius: 14, paddingHorizontal: 14, paddingVertical: 10 },
