...
export default function AdminLibraryDetailPage() {
  ...
  const statusBadge = useMemo(() => {
    ...
    const bg = active ? withAlpha(theme.colors.success, 0.12) : withAlpha(theme.colors.danger, 0.12);
    const fg = active ? theme.colors.success : theme.colors.danger;
    const border = active ? withAlpha(theme.colors.success, 0.25) : withAlpha(theme.colors.danger, 0.25);
